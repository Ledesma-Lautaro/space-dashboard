...
- [x] 01-02-PLAN.md — Tracer: end-to-end terminal slice — VT323, semantic tokens, one ASCII-chrome panel, the fixed CRT overlay and a persisting intensity control
...
- [x] 01-07-PLAN.md — Scene placeholder at reserved canvas dimensions plus the single-breakpoint responsive contract
...
|-------|----------------|--------|-----------|
| 1. Terminal Design System & App Shell | 7/7 | In Progress|  |
